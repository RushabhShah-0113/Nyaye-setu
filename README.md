...
cd NyayaSetu
Set up a MySQL instance and create a new database:
CREATE DATABASE nyayasetu;
Run the DDL script to create the schema:
mysql -u <username> -p nyayasetu < sql/ddl.sql
Explore the sample queries in sql/judiciary_queries.pdf to test the database.
Team
...
License
This project was developed solely for academic and educational purposes as part of a Database Management Systems course. See LICENSE for details.

Built with a commitment to making judicial information more accessible, transparent, and efficient.
